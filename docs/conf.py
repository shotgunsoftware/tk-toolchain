# -*- coding: utf-8 -*-
#
# pytest-tk-build documentation build configuration file, created by
...
project = u'pytest-tk-build'
copyright = u'2015, Shotgun Software'
author = u'Shotgun Software'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-tk-build Documentation',
     [author], 1)
]
