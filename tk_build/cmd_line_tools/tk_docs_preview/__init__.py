...
def main():
    ...
    """
        ...
        core_path = os.path.expandvars(os.path.expanduser(core_path)) if core_path else None
        bundle_path = os.path.expandvars(os.path.expanduser(bundle_path)) if bundle_path else None
